...
apps ={
    ...
    "Forticlient":{"type":"exe",  
                   "path":"FortiClientInstaller.exe", 
                   "args": ["/quiet", "/norestart"], 
                   "logo":"image/Forticlient.png"},

    "MoM Smart Client Printer":{"type":"msi", 
                                "path":"MomSmartClient_x64.msi_windows_x64_2024.2.1.3.msi", 
    ...
    "Office LTSC Standard Installer":{"type":"exe", 
                                      "path":"Office2021\\setup.exe", 
                                      "args": ["/configure",
                                               "configuration-Office2021standard.xml"], 
                                      "logo":"image/Office L.png"},  

    "Whatsapp":{"type": "exe",
                 "path": "WhatsApp Installer.exe",
                 "args": ["/s"],
...
preset = {
    "New laptop" : ["Chrome", "Acrobat", "Anydesk", "Click Share", "Eshare", "Forticlient", "MoM Smart Client Printer", "Microsoft Teams", "Team Viewer", "Office LTSC Standard Installer"]
}
        ...
        for app_name, app_info, in selected_apps:
                ...
                try:
                    if app_info["type"]== "winget":
                        result=subprocess.run(
                            ["winget", "install","--id", app_info["id"], "--exact", "--source", "winget", "--accept-package-agreements", "--accept-source-agreements"],
                            capture_output=True,
                            text=True,
                            # shell=True
                        )   
